...
const solutions: Solution[] = [
  { title: "Palm health mapping", description: "Give every mapped palm a stable identity, baseline, and repeat-survey history.", image: "palmwatch-hero.webp", alt: "Aerial view across a mapped oil-palm estate", tags: ["Palm ID", "Time series"] },
  { title: "Risk screening & prioritisation", description: "Bring spectral, structural, thermal, and contextual signals into one explainable review queue.", image: "palmwatch-drone.webp", alt: "Mapping drone surveying oil palms", tags: ["Multisignal", "Priority"] },
...
const services: Service[] = [
  { title: "Map & inventory", description: "Register estate boundaries, blocks, and stable palm identities before analysis begins.", image: "palmwatch-hero.webp", alt: "Aerial view of an oil-palm estate arranged in mapped blocks" },
  { title: "Calibrated aerial survey", description: "Capture repeat RGB, multispectral, and thermal evidence under controlled field protocols.", image: "palmwatch-drone.webp", alt: "Drone collecting calibrated imagery over mature oil palms" },
  { title: "Risk screening", description: "Compare each palm with its own history and relevant neighbours to find persistent change.", image: "palmwatch-hero.webp", alt: "Oil-palm rows viewed from above for comparative screening" },
  ...
  { title: "Monitoring & reporting", description: "Close the loop with repeat visits, intervention follow-ups, and estate-level evidence reports.", image: "palmwatch-drone.webp", alt: "Drone survey providing repeat monitoring evidence for an estate" },
];
