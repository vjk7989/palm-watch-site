...
function App() {
  ...
  return <>
    ...
    <main id="main">
      ...
      <section className="service-story" id="services" aria-labelledby="services-title">
        <div className="service-sticky">
          <div className="service-backgrounds" aria-hidden="true">{services.map((service, index) => <img className={index === activeService ? "active" : ""} key={service.title} src={asset(service.image)} alt="" decoding="async" />)}</div><div className="service-shade"/>
          <div className="service-stage">
            ...
            <article className="service-card" key={currentService.title}><img src={asset(currentService.image)} alt={currentService.alt} decoding="async"/><div><h3>{currentService.title}</h3><p>{currentService.description}</p></div></article>
    ...
    <footer className="footer-stage" style={{ backgroundImage: `url(${asset("palmwatch-hero.webp")})` }}><div className="footer-shade"/><div className="footer-tab"><div className="footer-brand"><a href="#home"><Brand /></a><p>Oil-palm intelligence,<br/>tree by tree.</p></div><div className="footer-column"><strong>Explore</strong><a href="#overview">Overview</a><a href="#solutions">Solutions</a><a href="#services">Services</a><a href="#features">Features</a></div><div className="footer-column"><strong>Research</strong><a href="#research">Study scope</a><a href="#faq">Questions</a><a href={asset("palmwatch-whitepaper.pdf")} target="_blank" rel="noreferrer">White paper ↗</a></div><div className="footer-column"><strong>Actions</strong><a href="#pilot">Plan a pilot</a><a href="#research">Review evidence</a><a href="#home">Back to top ↑</a></div><div className="footer-bottom"><span>AI-assisted screening. Field-confirmed decisions.</span><span>© 2026 PalmWatch. All rights reserved.</span></div></div></footer>
  </>;
}
